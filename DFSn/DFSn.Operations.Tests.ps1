...
Describe 'DFSn configuration operational readiness' {
   ...
   #Verifying using SavedDFSnSnapshot as reference
   Context 'Verifying DFSn Folder Targets SavedDFSnSnapshot'{
      $lookupFolderTargets = $DFSnConfiguration.FolderTargets | Group-Object -AsHashTable -Property Path
      $SavedDFSnSnapshot.FolderTargets |
      ForEach-Object {
